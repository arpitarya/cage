...
way a *shell* does, which is the whole point on Windows (PATHEXT, docs/adr/0008_graphify.md)
...
def _sh(cmdline: str, *, cwd: Path, env: dict, check: bool = True) -> subprocess.CompletedProcess:
    ...
    resolution of a bare name (D2/PATHEXT in docs/adr/0008_graphify.md)."""
