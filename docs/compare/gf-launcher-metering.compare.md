...
is precisely the drift [ADR 0007](../adr/0007-graphify-twin-pair-hand-paired-not-templated.md)
...
- [shim-contract.md](../shim-contract.md) — B5, and the B1–B8/D1–D7 contract B would amend
- [ADR 0007](../adr/0007-graphify-twin-pair-hand-paired-not-templated.md) — hand-paired,
