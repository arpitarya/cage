...
- cage: `transcript.py` HEAD (current capture behavior), `docs/research/copilot-vscode-token-sources.md` + `2026-08-02-copilot-credit-fields-real-stores.md` (real-store probes: `copilotCredits` float 11/348 requests all `copilot/auto`; `totalPremiumRequests: 0.33` float).
