...
> **⛔ SUPERSEDED — the pre-fix baseline is now published per-run as [run-002](2026-07-28-validation-run-002.md); the post-fix re-run is [run-003](2026-07-28-validation-run-003.md).** This was the first (pre-fix) publish of the validation report; preserved unedited below as evidence, not current. (Body/hash unchanged — banner is above the hashed range.)

**Report sha256 (body below the marker):** `3abe494f0d6049635baf1c6ce6ab6ebfe92a021303f7832885b8ce904c3f947a`
