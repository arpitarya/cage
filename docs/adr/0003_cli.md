---
adr: cli
status: current as of 2026-08-15 · 14 top-level entries · 23 addressable commands · an example per command AND rendered output for every printing view · gated bidirectionally against the live parser
