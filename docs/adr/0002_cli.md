---
adr: cli
status: current as of 2026-08-14 · 13 top-level entries · 27 addressable commands · gated bidirectionally against the live parser
...
flowchart TD
    ...
    G --> G2["task · authorship · study · policy"]
...
**All 27 addressable commands, each with a runnable line.** Examples are inline code
