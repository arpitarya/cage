...
- Cage's per-agent records ([ADR-CLAUDE](0003_claude.md) · [ADR-COPILOT](0004_copilot.md) ·
  [ADR-KIRO](0005_kiro.md) · [ADR-GRAPHIFY](0007_graphify.md)) each assume these five and
...
No hook writes usage, cage installs **no OS scheduler** (no launchd/systemd/cron/schtasks,
no `cage scheduler`), the capture and read paths touch **no network**, and MCP is the only
surface cage wires. Hands-off automation is the user's *own* cron line calling
`cage import` — documented, never created by cage.
*Ratified:* [0002](../../work/archive/adr/0002-universal-capture-global-ledger-explicit-import-export.md) ·
[0003](../../work/archive/adr/0003-hookless-capture-pull-only-mcp-only-wiring.md).
...
dimension is a machine fact ([ADR-KIRO](0005_kiro.md)).
*Ratified:* [0002](../../work/archive/adr/0002-universal-capture-global-ledger-explicit-import-export.md).
...
*Ratified:* [0004](../../work/archive/adr/0004-append-only-delta-rows-and-separate-by-schema.md).
...
*Ratified:* [0008](../../work/archive/adr/0008-line-match-authorship-counts-persisted-content-transient.md) ·
[0009](../../work/archive/adr/0009-kiro-cli-tool-run-bodies-read-transiently-never-persisted.md).
...
*Ratified:* [0011](../../work/archive/adr/0011-cage-measures-usage-not-cost.md).
