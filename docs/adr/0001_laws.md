...
- Cage's per-agent records ([ADR-CLAUDE](0002_claude.md) · [ADR-COPILOT](0003_copilot.md) ·
  [ADR-KIRO](0004_kiro.md) · [ADR-GRAPHIFY](0005_graphify.md)) each assume these five and
...
dimension is a machine fact ([ADR-KIRO](0004_kiro.md)).
*Ratified:* [0002](../../work/archive/adr/0002-universal-capture-global-ledger-explicit-import-export.md).
