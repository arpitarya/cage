...
status: IMPLEMENTED 2026-08-02 (v0.43, unreleased) — see ADR 0008
...
---
> **ARCHIVED — IMPLEMENTED for v0.43 (unreleased), 2026-08-02.** The rationale behind
...
> [PLAN.md §3.5](../PLAN.md), [FORMULAS.md §2.14](../FORMULAS.md) and [CLI.md](../CLI.md).
