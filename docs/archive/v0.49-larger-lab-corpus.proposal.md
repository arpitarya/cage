...
> explicit instruction at v0.49.0, rather than worked. **Never built; its trigger could not fire** — it was gated on NET-1 coming back net-negative at n = 5, and NET-1 was never run.
