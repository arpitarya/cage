...
in `cage.toml`. Specced as [claude-md-sync.handoff.md](v0.39-claude-md-sync.handoff.md) ·
[prompt](v0.39-claude-md-sync.prompt.md).
...
overrides before they land. Sibling to [claude-md-sources-authority.md](v0.39-claude-md-sources-authority.proposal.md);
