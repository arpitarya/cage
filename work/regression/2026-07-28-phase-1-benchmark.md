...
`cage/work/regression/2026-07-28-*` · `cage/docs/FORMULAS.md` §1.7.
...
1. Does the graphify PATH interceptor fire under the VS Code extensions at all?
   ...
   so the honest expected answer may be "no" — [finding](../../cage/work/regression/2026-07-28-finding-graphify-ab-no-fire.md).)
...
| limit | kind | why |
|---|---|---|
| kiro CLI token counts (all four fields) null | **FINAL** | store fields null on every turn (floor + large); proxy route closed four independent ways ([P2 probe](../../cage/work/regression/2026-07-28-kiro-proxy-probe.md); [FORMULAS §1.7](../../cage/docs/FORMULAS.md)) |
...
| field | captured (method) | verdict | perm. | evidence |
|---|---|---|---|---|
| tokens_in | ✅ measured | EXACT | — | 227,298 (V3) / 233,675 (V4), 3-way · run-003 §1. Pre-fix WRONG (189,788 / 191,414, −16.5% / −18.1%) → RESOLVED · [finding](../../cage/work/regression/2026-07-28-finding-copilot-resumed-undercount.md) |
...
| premium | ✅ measured | EXACT | — | `totalPremiumRequests` cumulative → delta-fixed, 0.33→0.66 on real `8073abba` · [finding](../../cage/work/regression/2026-07-28-finding-copilot-resumed-undercount.md), capture-precision §HIGH |
...
| field | captured (method) | verdict | perm. | evidence |
|---|---|---|---|---|
| tokens_in | null | HONEST-LIMIT | **FINAL** | store field null every turn; route closed 4 ways · [kiro finding](../../cage/work/regression/2026-07-28-finding-kiro-cli-sqlite-credits.md), [P2 probe](../../cage/work/regression/2026-07-28-kiro-proxy-probe.md) |
...
| surface | ✅ `"cli"` (declared-wins) | EXACT | — | `[sources.kiro] surface="cli"` now upgrades the built-in (collision fix) · [finding](../../cage/work/regression/2026-07-28-finding-surface-restamp-collision.md) |
...
|---|---|---|---|
| [graphify shim recursion](../../cage/work/regression/2026-07-28-finding-graphify-shim-recursion.md) | MED | **OPEN** | cage shim hardened (skips every interceptor, exit 127, re-entry guard); a **stale foreign dead-verb shim left on a real machine's PATH remains a hazard** the fix mitigates but cannot erase — reopens if a stacked-interceptor hang recurs in the wild |
| [graphify A/B didn't fire](../../cage/work/regression/2026-07-28-finding-graphify-ab-no-fire.md) | — | **OPEN** (product-level) | savings path validated directly (11,810 raw → 118 actual → **11,692 saved**, modeled); but agents don't shell out to graphify unprompted, so A−B = 0 through no cage fault — Phase 2 driver change |
| [copilot resumed undercount](../../cage/work/regression/2026-07-28-finding-copilot-resumed-undercount.md) | HIGH | ✅ RESOLVED | delta-id fix; self-heal 70,071 → 107,581 (+37,510 exact) → +0; verified run-003 8/8 |
| [kiro CLI SQLite / credits](../../cage/work/regression/2026-07-28-finding-kiro-cli-sqlite-credits.md) | HIGH | ✅ CLOSED | credits parser shipped; exact-token route closed by [P2 probe](../../cage/work/regression/2026-07-28-kiro-proxy-probe.md) |
| [surface-restamp collision](../../cage/work/regression/2026-07-28-finding-surface-restamp-collision.md) | LOW | ✅ RESOLVED | declared `surface` now wins on built-in collision |
