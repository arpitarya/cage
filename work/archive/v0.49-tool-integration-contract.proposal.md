...
> explicit instruction at v0.49.0, rather than worked. **Never built** — gated on a second tool (fux) that does not yet exist. Generalising from one instance was the stated reason not to start.
