...
> explicit instruction at v0.49.0, rather than worked. **Never built; its trigger (a third table removal) never fired.** Its own stated cost still stands: a fully synthetic bundle stops testing that sync works on the actually-shipped bundle.
