...
- **Field session 2026-08-14**, against real stores:
  [`work/research/2026-08-13-kiro-per-chat-usage-fetch-spec.md`](../../research/2026-08-13-kiro-per-chat-usage-fetch-spec.md).
...
- **Why `saved` is gross** — the finding that produced `GROSS_NOTE`:
  [`work/regression/2026-08-01-finding-saved-is-gross.md`](../../regression/2026-08-01-finding-saved-is-gross.md).
- **The build's own spec:** `work/archive/v0.50-usage-only.{handoff,prompt}.md`.
