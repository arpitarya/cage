...
**Also the first artifact of the [tool-integration-contract](../work/archive/v0.49-tool-integration-contract.proposal.md)** —
...
`docs/`, not package data) are recorded in [ADR 0007](../work/archive/adr/0007-graphify-twin-pair-hand-paired-not-templated.md).
