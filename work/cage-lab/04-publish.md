...
- Copy into `cage/work/regression/`, dated, with a **sha256 sidecar**.
- Add the index row to `work/regression/README.md`.
- **`work/regression/**` is append-only.** Never edit a published file.
...
- Bump the relevant `work/DOC-REGISTRY.md` rows.
