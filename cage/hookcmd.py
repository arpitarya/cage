...
def _open_tasks(root: Path, session: str) -> list[str]:
    ...
    # it; KIRO-CALLS-LEG moved kiro's rows out too (2026-08-15). An open task is therefore
    # only findable for a consumer/custom row — stated in TASK-GRAIN-SPINE, and NOT
    # patched with a timestamp-proximity guess. The caller
